...
dir_lists = glob.glob("/home/AIWolfPy/pre_logs/cedec2018_5/*")
print(dir_lists)
...
for d in dir_lists:
    ...
    for f in file_lists:
        ...
        print(text)
        wf = open("/home/AIWolfPy/train_cedec5/train-log.txt",mode="a")
        wf.write(text)
        wf.write("\n")
        wf.close()
        count+=1
        if count%1000==0:
            filename = "/home/AIWolfPy/train_cedec5/trainning_model-" + str(count) + ".sav"
